...
const file_proto_user_proto_rawDesc = "" +
	...
	"\n" +
	"updated_at\x18\x06 \x01(\v2\x1a.google.protobuf.TimestampR\tupdatedAt2\xf0\x02\n" +
	"\vUserService\x120\n" +
...
var file_proto_user_proto_goTypes = []any{
	...
	(*GetUserLogsRequest)(nil),         // 8: user.GetUserLogsRequest
	(*GetUserLogsResponse)(nil),        // 9: user.GetUserLogsResponse
	(*User)(nil),                       // 10: user.User
	(*UserSettings)(nil),               // 11: user.UserSettings
	(*UserPreferences)(nil),            // 12: user.UserPreferences
	(*UserLogs)(nil),                   // 13: user.UserLogs
	(*timestamppb.Timestamp)(nil),      // 14: google.protobuf.Timestamp
}
var file_proto_user_proto_depIdxs = []int32{
	10, // 0: user.LoginResponse.user:type_name -> user.User
	10, // 1: user.GetUserByIDResponse.user:type_name -> user.User
	11, // 2: user.GetUserSettingsResponse.user_settings:type_name -> user.UserSettings
	12, // 3: user.GetUserPreferencesResponse.user_preferences:type_name -> user.UserPreferences
	13, // 4: user.GetUserLogsResponse.user_logs:type_name -> user.UserLogs
	14, // 5: user.User.membership_expire:type_name -> google.protobuf.Timestamp
	14, // 6: user.User.created_at:type_name -> google.protobuf.Timestamp
	14, // 7: user.User.updated_at:type_name -> google.protobuf.Timestamp
	14, // 8: user.UserSettings.created_at:type_name -> google.protobuf.Timestamp
	14, // 9: user.UserSettings.updated_at:type_name -> google.protobuf.Timestamp
	14, // 10: user.UserPreferences.created_at:type_name -> google.protobuf.Timestamp
	14, // 11: user.UserPreferences.updated_at:type_name -> google.protobuf.Timestamp
	14, // 12: user.UserLogs.created_at:type_name -> google.protobuf.Timestamp
	14, // 13: user.UserLogs.updated_at:type_name -> google.protobuf.Timestamp
	0,  // 14: user.UserService.Login:input_type -> user.LoginRequest
	2,  // 15: user.UserService.GetUserByID:input_type -> user.GetUserByIDRequest
	4,  // 16: user.UserService.GetUserSettings:input_type -> user.GetUserSettingsRequest
	6,  // 17: user.UserService.GetUserPreferences:input_type -> user.GetUserPreferencesRequest
	8,  // 18: user.UserService.GetUserLogs:input_type -> user.GetUserLogsRequest
	1,  // 19: user.UserService.Login:output_type -> user.LoginResponse
	3,  // 20: user.UserService.GetUserByID:output_type -> user.GetUserByIDResponse
	5,  // 21: user.UserService.GetUserSettings:output_type -> user.GetUserSettingsResponse
	7,  // 22: user.UserService.GetUserPreferences:output_type -> user.GetUserPreferencesResponse
	9,  // 23: user.UserService.GetUserLogs:output_type -> user.GetUserLogsResponse
